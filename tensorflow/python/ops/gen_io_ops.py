...
def _fixed_length_record_reader(record_bytes, header_bytes=None,
  ...
  """
  return _op_def_lib.apply_op("FixedLengthRecordReader",
                              record_bytes=record_bytes,
                              header_bytes=header_bytes,
                              footer_bytes=footer_bytes, container=container,
...
def _identity_reader(container=None, shared_name=None, name=None):
  ...
  Returns:
    A `Tensor` of type mutable `string`. The handle to reference the Reader.
  """
  return _op_def_lib.apply_op("IdentityReader", container=container,
                              shared_name=shared_name, name=name)
...
def matching_files(pattern, name=None):
  ...
  """
  return _op_def_lib.apply_op("MatchingFiles", pattern=pattern, name=name)
...
def read_file(filename, name=None):
  ...
  """
  return _op_def_lib.apply_op("ReadFile", filename=filename, name=name)
...
def _reader_num_records_produced(reader_handle, name=None):
  ...
  """
  return _op_def_lib.apply_op("ReaderNumRecordsProduced",
...
def _reader_num_work_units_completed(reader_handle, name=None):
  ...
  Returns:
    A `Tensor` of type `int64`.
  """
  return _op_def_lib.apply_op("ReaderNumWorkUnitsCompleted",
                              reader_handle=reader_handle, name=name)
...
def _reader_read(reader_handle, queue_handle, name=None):
  ...
  """
  return _op_def_lib.apply_op("ReaderRead", reader_handle=reader_handle,
...
def _reader_reset(reader_handle, name=None):
  ...
  """
  return _op_def_lib.apply_op("ReaderReset", reader_handle=reader_handle,
                              name=name)
...
def _reader_restore_state(reader_handle, state, name=None):
  ...
  Returns:
    The created Operation.
  """
  return _op_def_lib.apply_op("ReaderRestoreState",
...
def _reader_serialize_state(reader_handle, name=None):
  ...
  Returns:
    A `Tensor` of type `string`.
  """
  return _op_def_lib.apply_op("ReaderSerializeState",
                              reader_handle=reader_handle, name=name)
...
def _restore(file_pattern, tensor_name, dt, preferred_shard=None, name=None):
  ...
  """
  return _op_def_lib.apply_op("Restore", file_pattern=file_pattern,
...
def _restore_slice(file_pattern, tensor_name, shape_and_slice, dt,
  ...
  Returns:
    A `Tensor` of type `dt`. The restored tensor.
  """
  return _op_def_lib.apply_op("RestoreSlice", file_pattern=file_pattern,
...
def _save(filename, tensor_names, data, name=None):
  ...
  Args:
    ...
    data: A list of `Tensor` objects with types from: `bool`, `float32`, `float64`, `int32`, `int64`, `quint8`, `qint8`, `qint32`.
      `N` tensors to save.
    name: A name for the operation (optional).
  ...
  Returns:
    The created Operation.
  """
  return _op_def_lib.apply_op("Save", filename=filename,
                              tensor_names=tensor_names, data=data, name=name)
...
def _save_slices(filename, tensor_names, shapes_and_slices, data, name=None):
  ...
  *  `start,length` where `start` and `length` are integers.  In that
  ...
  Returns:
    The created Operation.
  """
  return _op_def_lib.apply_op("SaveSlices", filename=filename,
...
def _sharded_filename(basename, shard, num_shards, name=None):
  r"""Generate a sharded filename. The filename is printf formated as
  ...
  Returns:
    A `Tensor` of type `string`.
  """
  return _op_def_lib.apply_op("ShardedFilename", basename=basename,
...
def _sharded_filespec(basename, num_shards, name=None):
  ...
  Returns:
    A `Tensor` of type `string`.
  """
  return _op_def_lib.apply_op("ShardedFilespec", basename=basename,
...
def _tf_record_reader(container=None, shared_name=None, name=None):
  ...
  Returns:
    A `Tensor` of type mutable `string`. The handle to reference the Reader.
  """
  return _op_def_lib.apply_op("TFRecordReader", container=container,
                              shared_name=shared_name, name=name)
...
def _text_line_reader(skip_header_lines=None, container=None,
  ...
  Returns:
    A `Tensor` of type mutable `string`. The handle to reference the Reader.
  """
  return _op_def_lib.apply_op("TextLineReader",
...
def _whole_file_reader(container=None, shared_name=None, name=None):
  ...
  Returns:
    A `Tensor` of type mutable `string`. The handle to reference the Reader.
  """
  return _op_def_lib.apply_op("WholeFileReader", container=container,
                              shared_name=shared_name, name=name)
